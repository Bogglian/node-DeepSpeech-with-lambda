...
module.exports = (audioPath, outputGraph, alphabet, lm, trie) => {
  ...
  const AUDIO = audioPath || './audio/8455-210777-0068.wav';
  ...
  function bufferToStream(streamBuffer) {
    const stream = new Duplex();
    stream.push(streamBuffer);
    stream.push(null);
    return stream;
  }
  ...
  audioStream.on('finish', () => {
    ...
    console.error('Loading model from file %s', outputGraph);
